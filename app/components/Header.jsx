...
const Header = () => {
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4 mt-2 mb-10'>
            ...
            >
                <Image src={assets.profile_img} alt='' className='rounded-full w-32 mt-20'></Image>
            </motion.div>
            <div>
                <motion.h3 className='gap-2 text-xl md:text-2xl mb-3'
                ...
                >frontend developer based in Kabul</motion.h3>
                <motion.p className='max-w-2xl mx-auto mt-2'
                    initial={{ y: -20, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    transition={{ duration: 0.6, delay: 0.3 }}
                >I am a frontend developer from Kabul Afghanistan. with 7 years of experience in multiple companies like Election Commission of Afghanistan, Fanoos, Talia, and Quika.</motion.p>
