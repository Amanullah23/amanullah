      ...
      <form onSubmit={onSubmit} className="max-w-2xl mx-auto" >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-5 mb-2">
          <input type="text"
            ...
            required
            className="w-full p-3 outline-none border border-gray-400 rounded-md bg-white" name='name'
          />
          <input
            type="email"
            placeholder="Enter your email"
            required
            className="w-full p-3 outline-none border border-gray-400 rounded-md bg-white" name='email'
          />
        </div>
        ...
        <button type="submit"
          className="cursor-pointer relative z-10 py-3 px-8 w-max flex items-center justify-center gap-3 bg-black/80 text-white rounded-full mx-auto hover:bg-sky-700 duration-500">
          Submit Now
