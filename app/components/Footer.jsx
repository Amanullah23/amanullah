      ...
      <div className="text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-6">
        ...
        <ul className="flex items-center gap-5 justify-center mt-4">
          ...
          <li className="hover:text-blue-500 transition-transform duration-300 hover:translate-y-[-3px]">
            <a
              target="_blank"
              href="https://www.linkedin.com/in/amanullah-yawari/"
            >
              LinkedIn
            </a>
          </li>
          <li className="hover:text-blue-500 transition-transform duration-300 hover:translate-y-[-3px]">
            <a
              target="_blank"
              href="https://x.com/theyawari?t=zTjo68BwwvyHkgNo89SX-g&s=09"
            >
              X
            </a>
          </li>
          <li className="hover:text-blue-500 transition-transform duration-300 hover:translate-y-[-3px]">
            <a
              target="_blank"
              href="https://www.facebook.com/share/17tGSi8eNF/"
            >
              Facebook
            </a>
          </li>
          <li className="hover:text-red-500 transition-transform duration-300 hover:translate-y-[-3px]">
            <a
              target="_blank"
              href="https://www.instagram.com/amanullah_yawari?igsh=YjF4ZHJjZ29la2Rt"
            >
              Instagram
            </a>
          </li>
